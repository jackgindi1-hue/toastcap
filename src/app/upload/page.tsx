...
export default function UploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to /dlvc - THIS IS BULLETPROOF
      router.push('/dlvc');
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border-4 border-[#FF6B35] p-6 md:p-8">
            ...
            <div className="mb-8">
              ...
              {/* Legal Disclosure */}
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 text-xs text-gray-600 leading-relaxed">
                <p>
                  Applicant authorizes toastcapital.com (TC) and its assignees, agents, banks or financial
                  institutions to obtain an investigative or consumer report from a credit bureau or a credit
                  agency given on any statement or data obtained from applicant. Applicant hereby authorizes
                  TC and its designees to apply on behalf of the consumer for financing and funding to various
                  lenders and organizations including but not limited to Private Lenders, as elected by TC.
                  This authority will continue until withdrawn in writing by the undersigned account holder.
                  The Undersigned hereby certifies that they are duly authorized to execute this form on behalf
                  of the above listed Business entity & its account holder(s).
                </p>
              </div>
