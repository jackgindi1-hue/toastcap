...
// POST /api/leads/[id]/send-email - Send email to a lead (PROTECTED)
export async function POST(
  ...
  try {
    ...
    const trackingPixel = `<img src="${process.env.NEXT_PUBLIC_SITE_URL || 'https://toastcap.com'}/api/track/open?${trackingParams.toString()}" width="1" height="1" style="display:none" />`;
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p><a href="https://toastcap.com/dlvc" style="display: inline-block; background: #1E3A8A; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px;">Upload Documents</a></p>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #1E3A8A; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">See My Approved Amount →</a></p>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #1E3A8A; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Check My Offer →</a></p>
  </div>
</body>
</html>`;
}
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #FF6B35; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Accept Invitation →</a></p>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #DC2626; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Check My Special Rate →</a></p>
  </div>
</body>
</html>`;
}
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #1E3A8A; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Yes, Show Me My Offer →</a></p>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <div style="padding: 40px;">
      <img src="https://toastcap.com/toast-capital-logo.png" alt="Toast Capital" width="150" style="margin-bottom: 20px;">
      ...
      <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #FF6B35; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">See What I Qualify For →</a></p>
    </div>
  </div>
</body>
</html>`;
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #1E3A8A; color: white; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 18px;">Check My Offer →</a></p>
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f5;">
  <div style="background: white; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="text-align: center;"><a href="https://toastcap.com/quote" style="display: inline-block; background: #059669; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">Prepare for Peak Season →</a></p>
  </div>
</body>
</html>`;
}
