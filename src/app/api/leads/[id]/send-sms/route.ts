...
// POST /api/leads/[id]/send-sms - Send SMS to a lead (PROTECTED)
...
function getSmsTemplate(templateId: string, lead: any): string {
  ...
  const templates: Record<string, string> = {
    ...
    'docs_reminder': `Hi ${firstName}! We're still waiting on your documents to complete your funding application for ${businessName}. Upload them here: toastcap.com/dlvc`,
    ...
    'follow_up_quote': `Hi ${firstName}! You started a funding application for ${businessName} but haven't completed it yet. Finish in 2 minutes: toastcap.com/upload - Questions? (617) 533-3190`,
    'special_offer': `${firstName}, special offer for ${businessName}! Apply this week for reduced fees + priority processing. Limited time: toastcap.com/quote - Call: (617) 533-3190`,
    'seasonal': `Hi ${firstName}! Peak season is coming - is ${businessName} ready? Get funded now to stock up & hire. Check your offer: toastcap.com/quote`,
  };
