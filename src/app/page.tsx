          ...
          {chartData.map((d, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Plus icon on bar */}
                  <div className={`absolute -top-4 left-1/2 -translate-x-1/2 w-7 h-7 rounded-full bg-[#FF6B35] flex items-center justify-center text-white text-sm font-bold shadow-md transition-all duration-200 opacity-100`}>
                    +
                  </div>
                </div>
