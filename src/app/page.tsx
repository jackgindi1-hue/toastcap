...
import { Check, ChevronDown, ChevronRight, Play, Phone, X, Building2, Coffee, Store, Utensils, ArrowRight, ArrowLeft, Loader2 } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
function HomeContent() {
  ...
  const { tokenState, token, leadData } = useTokenSession('homepage');
  ...
  // Helper to generate URLs with token (uses session token)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center text-gray-400">
          <h1 className="text-7xl font-extralight mb-2">404</h1>
              ...
              <div className="flex flex-col items-start">
                ...
                {isBusinessHours() ? (
                  ...
                  <>
                    ...
                    <span className="text-[10px] md:hidden text-gray-600 flex items-center gap-1">Mon-Fri 9-6 ET <span className="w-1.5 h-1.5 bg-yellow-500 rounded-full inline-block"></span></span>
                  </>
                )}
